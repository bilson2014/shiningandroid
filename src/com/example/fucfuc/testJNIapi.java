...
public class testJNIapi {
     ...
     */
	public static native int SynthesisVideo(String videoPath1, String imagePath,String width,String  height,String lenght);
	 ...
	 */
	public static native int  cropVideo(String inPath,String VideoWidth,String height);
}
