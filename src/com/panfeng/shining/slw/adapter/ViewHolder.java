...
public class ViewHolder {
	 ...
	 */
	private ViewHolder(final Context context,final int itemLayoutResId,final int position,final ViewGroup parent) {
	 ...
	 */
	public static ViewHolder getViewHolder(final Context context,final int itemLayoutResId,final int position,
	...
	public <T extends View> T getView(final int viewResId) {
	...
	public ViewHolder setText(final int viewResId,final String text) {
