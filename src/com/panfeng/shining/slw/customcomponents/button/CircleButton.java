package com.panfeng.shining.slw.customcomponents.button;
...
public class CircleButton extends ImageView {
	...
	@SuppressLint("NewApi") private void hidePressedRing() {
		pressedAnimator.setFloatValues(pressedRingWidth, 0f);
		pressedAnimator.start();
	}

	@SuppressLint("NewApi") private void showPressedRing() {
